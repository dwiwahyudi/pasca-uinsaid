...
<head>
  ...
  <title>Pasca Sarjana UIN RM Said</title>
  <base href="<?php echo base_url();?>">
  <script src="<?php echo base_url();?>assets/dist/js/arabic.js"></script>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo base_url();?>assets/img/uin-said.png" alt="UIN RM Said Surakarta" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo base_url();?>index.php" class="brand-link">
      ...
      <span class="pl-2">
      <i class="fas fa-spa" style="color: #ffae00;"></i>
      </span>
        <span class="brand-text font-weight-light"> Pasca UIN RM Said</span>
    </a>
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          ...
          if($this->session->userdata('acc_type') == '10'){
            ...
            $id = decrypt($this->session->userdata('uid'));
          }
          ?>
          <img src="<?php echo base_url().get_user_image($this->session->userdata('acc_type'),$id);?>" class="img-circle elevation-2" alt="User Image">
          <!-- <?=get_user_image($this->session->userdata('acc_type'),$id);?> -->
        </div>
        <div class="info">

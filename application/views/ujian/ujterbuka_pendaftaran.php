<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class="far fa-clipboard text-kunyit"></i> Pendaftaran Ujian Terbuka</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="card">
                        <form id="form-ujterbuka" type="ujterbuka">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">Lembar persetujuan Ujian Terbuka  <span class="text-danger">*</span></div>
                                            <div class="col-lg-8 col-md-8">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">Ringkasan Disertasi (15 - 20 halaman)  <span class="text-danger">*</span></div>
                                            <div class="col-lg-8 col-md-8">
                                                <input type="file" name="dok_ringkasan_disertasi" id="dok_ringkasan_disertasi" class="form-control required">
                                            </div>
                                        </div>
                                    </div>                         
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">Nota Promotor/Co-Promotor  <span class="text-danger">*</span></div>
                                            <div class="col-lg-8 col-md-8">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">Persetujuan/Pengesahan revisi Ujian Tertutup<span class="text-danger">*</span></div>
                                            <div class="col-lg-8 col-md-8">
                                                <input type="file" name="dok_pengesahan_revisi" id="dok_pengesahan_revisi" class="form-control required">
                                            </div>
                                        </div>
                                    </div>                          
                                    <div class="form-group">

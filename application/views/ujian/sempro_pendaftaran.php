<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class="far fa-clipboard text-kunyit"></i> Pendaftaran Ujian Seminar Proposal</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="card">
                        <form id="form-sempro" type="sempro">
                                ...
                                <!-- <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"> -->
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                ...
                                                <input type="hidden" id="jns_laporan" name="jns_laporan" value="<?=$data->jenjang == 'S2'?'1':'2';?>">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <textarea name="judul_id" id="judul_id" rows="2 " class="form-control required" style="resize:none" placeholder="Judul penelitian tesis/disertasi dalam Bahasa Indonesia"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <textarea name="judul_en" id="judul_en" rows="2 " class="form-control required" style="resize:none" placeholder="Judul penelitian tesis/disertasi dalam Bahasa Inggris"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <textarea name="judul_ar" id="judul_ar" rows="2 " class="form-control required arabic" onkeyup="arabicValue(this);" dir="rtl" style="resize:none" placeholder="Judul penelitian tesis/disertasi dalam Bahasa Arab"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                <!-- </div> -->

<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class="far fa-clipboard text-kunyit"></i> Pendaftaran Ujian Tertutup</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="card">
                        <form id="form-ujtertutup" type="ujtertutup">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">Lembar persetujuan Promotor/Co-Promotor  <span class="text-danger">*</span></div>
                                            <div class="col-lg-8 col-md-8">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">Lembar persetujuan/pengesahan revisi seminar hasil <span class="text-danger">*</span></div>
                                            <div class="col-lg-8 col-md-8">
                                                <input type="file" name="dok_pengesahan_revisi" id="dok_pengesahan_revisi" class="form-control required" placeholder="Hasil cek plagiat/turnitin">
                                            </div>
                                        </div>
                                    </div>                           
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">Kartu Hasil Studi (KHS) selama studi <span class="text-danger">*</span></div>
                                            <div class="col-lg-8 col-md-8">
                                                <input type="file" name="dok_khs" id="dok_khs" class="form-control required">
                                            </div>
                                        </div>
                                    </div>                                                                                          
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">Bukti pembayaran Disertasi <span class="text-danger">*</span></div>
                                            <div class="col-lg-8 col-md-8">
                                                <input type="file" name="dok_bayar_disertasi" id="dok_bayar_disertasi" class="form-control required">
                                            </div>
                                        </div>
                                    </div>                                                                                                                            
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">LoA Artikel Jurnal <span class="text-danger">*</span></div>
                                            <div class="col-lg-8 col-md-8">
                                                <input type="file" name="dok_loa" id="dok_loa" class="form-control required">
                                            </div>
                                        </div>
                                    </div>                                                                                                                        
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">Naskah Artikel Jurnal <span class="text-danger">*</span></div>
                                            <div class="col-lg-8 col-md-8">
                                                <input type="file" name="dok_artikel" id="dok_artikel" class="form-control required">
                                            </div>
                                        </div>
                                    </div>                                                                                                                      
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">Sertifikat TOEFL (min sekor 500) <span class="text-danger">*</span></div>
                                            <div class="col-lg-8 col-md-8">
                                                <input type="file" name="dok_toefl" id="dok_toefl" class="form-control required">
                                            </div>
                                        </div>
                                    </div>             
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">Bukti pembayaran SPP/UKT semester terakhir<span class="text-danger">*</span></div>
                                            <div class="col-lg-8 col-md-8">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">Surat Bebas Keuangan <span class="text-danger">*</span></div>
                                            <div class="col-lg-8 col-md-8">
                                                <input type="file" name="dok_bebas_keuangan" id="dok_bebas_keuangan" class="form-control required">
                                            </div>
                                        </div>
                                    </div>      
                                    <div class="form-group">

<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class="fab fa-wpforms text-kunyit"></i> Rekam Surat Cuti Kuliah</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <form class="form" id="form-cuti">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-1"><input type="text" name="no_surat" id="no_surat" class="form-control required" placeholder="Nomor" value="<?php echo (intval('no_surat') + 1);?>"></div>
                                        <div class="col-5"><input type="text" name="ext_surat" class="form-control required" id="ext_surat" placeholder="Ekstensi" value="<?=$ext;?>"></div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">

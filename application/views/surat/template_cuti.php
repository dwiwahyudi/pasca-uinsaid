...
<body>
    ...
    <div class="text-center">
        <p><strong><h3>SURAT KETERANGAN CUTI KULIAH</strong></h3>
        Nomor : B- <?=$data->no_surat.$data->ext_surat;?></p>
    </div>
    <p><?php echo isset($sql)?$sql:''; ?></p>
<p>Yang bertanda tangan di bawah ini Direktur Pascasarjana UIN RM Said Surakarta menerangkan bahwa :</p>
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tbody>
        ...
        <tr>
            <td>Semester</td>
            <td>: </td>
            <td> <?=$mhs->semester == '1'?'Ganjil':'Genap';?></td>
        </tr>
        <tr>
            <td>Angkatan</td>
            <td>: </td>
...
<p></p>
sedang menjalani CUTI KULIAH pada:<br>
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tbody>
        <tr>
